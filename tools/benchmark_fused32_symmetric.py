"""Symmetric two-model full-API comparison of one fused32 layout against an old shader."""
...
def main():
    ...
    parser.add_argument("--kernels", nargs="+", choices=KERNELS, default=[KERNELS[1]])
